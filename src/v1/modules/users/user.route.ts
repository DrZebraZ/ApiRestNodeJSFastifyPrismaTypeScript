...
import { changePasswordHandler, editPerfilHandler, getAllUsersHandler, loginUserHandler, registerTeacherHandler, registerUserHandler } from "./user.controllers" 
...
async function userRoutesV1(server: FastifyInstance){
  ...
  server.put('/editProfile', { preHandler:[server.RequireAuth], schema:{body:$ref('createEditUserSchema')}}, editPerfilHandler);
